...
# 02/24/2020
# Objectives
# Learn how to write Java methods in a class
# Learn to write instance variables and necessary methods in a class
# Learn to test the Classes
# Exercise
# Performance Criteria
# Can write Java methods in a class. * Can write a method with a return type, method name, parameter list, and a method body. * Can write a method with correct syntax.
# Can write a class. * Can identify and declare instance variable(s). * Can write usual accessor and mutator methods for a class. * Can write constructors for a class. * Can write other required methods in a class such as toString()
# Can write an application class to test a class. * Can instantiate objects of a class. * Can call methods to display objects' data.
# Assignment
